    ...
    >
      ...
      <CardContent className="text-center space-y-6 relative z-10">
        ...
        <div className="relative">
          <div className={`w-40 h-40 mx-auto rounded-2xl bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500 p-1 transition-transform duration-300 ${isHovered ? 'scale-105 rotate-1' : ''}`}>
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-blue-200 text-sm mt-1">Token ID: 0x7d4a...3f2b</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 space-y-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-lg font-semibold text-blue-300">$15,120</span>
            </div>
            <div className="flex justify-between items-center">
